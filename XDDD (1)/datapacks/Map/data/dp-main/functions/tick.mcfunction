...
execute at @p run execute if block ~ ~-1.3 ~ minecraft:red_glazed_terracotta run kill @p

#piston game
function dp-main:blue-games/pistons/pistons-controller

execute if entity @p[gamemode=!adventure] run execute if score cheats Bool matches 0 run function dp-main:punishment
